...
def generate_flooding_dataset(
    ...
    # classified-negative images that were NOT annotated = (all classified
    # negative) - (annotated classified-negatives = n_tn + n_fn). The earlier
    # formula omitted n_tn, breaking the invariant
    # positives_not_annotated + negatives_not_annotated == total_not_annotated.
    result['negatives_not_annotated'] = (result['n_total'] - result['n_classified_positive']) - (result['n_tn'] + result['n_fn'])
